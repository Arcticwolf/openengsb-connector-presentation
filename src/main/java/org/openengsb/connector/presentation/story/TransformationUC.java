...
package org.openengsb.connector.presentation.story;
...
import org.openengsb.connector.presentation.ModelDefinitions;
import org.openengsb.connector.presentation.StoryException;
import org.openengsb.core.api.model.ModelDescription;
import org.openengsb.core.ekb.api.ModelRegistry;
import org.openengsb.core.ekb.api.TransformationEngine;
import org.openengsb.core.ekb.api.transformation.TransformationDescription;
import org.openengsb.domain.issue.Issue;
import org.openengsb.domain.presentation.model.ExternalIssue;
...
public class TransformationUC {
    ...
    public String runUC() {
        ...
        if (req.getShortDescription() == null || !req.getShortDescription().equals("this is a summary")) {
            return "Transformation from ext requirement to the requirement model failed. Short description "
        ...
        if (issue.getOwner() == null || !issue.getOwner().equals("joe")) {
            return "Transformation from requirement to the issue model failed. Owner should be 'joe' but was "
                    + issue.getOwner();
        }
        ...
        if (extissue.getTitle() == null || !extissue.getTitle().equals("this is a summary")) {
            return "Transformaton from issue to ext issue model failed. Titel should be 'this is a summary' but "
        ...
        return "The use case ran through successfully! Duration: " + duration + " ms.";
    }
